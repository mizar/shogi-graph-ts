...
<meta property="og:image" content="https://golan.sakura.ne.jp/denryusen/dr1_test3/shogiban_gd1200.php?csa=<?php echo urlencode($_GET["gi"]) ?>.csa&tesuu=<?php echo urlencode($_GET["te"]) ?>"/>
<meta property="og:url" content="https://golan.sakura.ne.jp/denryusen/dr1_test3/dist/denryusen_single#<?php echo urlencode($_GET["gi"]) ?>"/>
...
var denryuOrgUrlBase = "https://www.golan.sakura.ne.jp/denryusen/dr1_test3";
var gameBoardProp = {
...
<body><div><a href="http://www.denryu-sen.jp/">電竜戦ホーム</a> <a href="https://golan.sakura.ne.jp/denryusen/dr1_test3/dr1_live.php">中継トップ</a> <a href="./denryusen_single_test">単一棋譜版</a> <a href="./denryusen_multi_test">複数棋譜版</a></div><script type="text/javascript" src="./main.js"></script></body>
</head>
